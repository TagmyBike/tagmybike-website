...
Änderungen und Ergänzungen dieser AGB bedürfen der Schriftform. Dies gilt auch für die Aufhebung dieses Schriftformerfordernisses.`
            },
            {
                icon: Mail,
                title: "§ 12 Kontakt",
                content: `BOOOST E-Mobility Solutions GmbH
        ...
        sections: [
            {
                ...
                content: `These Terms of Service (hereinafter "Terms") govern all contracts between BOOOST E-Mobility Solutions GmbH, Großenbaumer Str. 252, 45479 Mülheim an der Ruhr, Germany (hereinafter "Provider" or "we") and the Customer (hereinafter "Customer" or "you") regarding the use of TagMyBike services, including GPS tracking hardware, software, and related services.
